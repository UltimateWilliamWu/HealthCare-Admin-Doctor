<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="保质期" prop="dateofuse">
        <el-input
          v-model="queryParams.dateofuse"
          placeholder="请输入保质期"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="medicineList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="药品编号" align="center" prop="id" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="药品名" prop="name">
          <el-input v-model="form.name" placeholder="请输入药品名" />
        </el-form-item>
        <el-form-item label="制造商" prop="manufacturer">
        ...
        <el-form-item label="生产日期" prop="productiondate">
          <el-input v-model="form.productiondate" placeholder="请输入生产日期" />
        </el-form-item>
        <el-form-item label="保质期" prop="dateofuse">
          <el-input v-model="form.dateofuse" placeholder="请输入保质期" />
        </el-form-item>
      </el-form>
