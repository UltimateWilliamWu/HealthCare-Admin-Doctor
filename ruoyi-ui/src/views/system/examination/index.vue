    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:examination:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:examination:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleImport"
          v-hasPermi="['system:examination:import']"
        >导入</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:examination:export']"
        >导出</el-button>
      </el-col>
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/system/examination/importData"
      },
      // 遮罩层
      loading: true,
      // 选中数组
  ...
  methods: {
    /** 导入按钮操作 */
    handleImport() {
      this.upload.title = "收费项目导入";
      this.upload.open = true;
    },
    /** 下载模板操作 */
    importTemplate() {
      this.download('system/examination/importTemplate', {
      }, `examination_template_${new Date().getTime()}.xlsx`)
    },
    // 文件上传中处理
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除检查费设置编号为"' + ids + '"的数据项？').then(function() {
