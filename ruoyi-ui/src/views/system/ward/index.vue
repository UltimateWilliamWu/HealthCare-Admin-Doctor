...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/system/ward/importData"
      },
      // 遮罩层
      loading: true,
      // 选中数组
  ...
  methods: {
    ...
    /** 下载模板操作 */
    importTemplate() {
      this.download('system/ward/importTemplate', {
      }, `ward_template_${new Date().getTime()}.xlsx`)
    },
    // 文件上传中处理
