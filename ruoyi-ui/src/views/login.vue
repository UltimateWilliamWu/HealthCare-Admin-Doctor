...
<template>
  <div class="center">
    <h1 style="color: white">OSH-HealthCare</h1>
    <div class="logon">
          ...
          <el-form ref="loginForm" :model="loginForm" :rules="loginRules" >
            <el-form-item prop="username">
              <el-input
                ...
                placeholder="账号"
              >
                <svg-icon slot="prefix" icon-class="user" class="el-input__icon input-icon" style="margin-top: 20px"/>
              </el-input>
            </el-form-item>
            <el-form-item prop="password">
              ...
              >
                <svg-icon slot="prefix" icon-class="password" class="el-input__icon input-icon" style="margin-top: 20px"/>
              </el-input>
            </el-form-item>
            <el-form-item prop="code" v-if="captchaEnabled">
              <el-input
                ...
                @keyup.enter.native="handleLogin"
              >
                <svg-icon slot="prefix" icon-class="validCode" class="el-input__icon input-icon" style="margin-top: 20px" />
              </el-input>
              <div class="login-code" style="margin-top: 3%">
                <img :src="codeUrl" @click="getCode" class="login-code-img" alt="无法获取验证码"/>
              </div>
            </el-form-item>
